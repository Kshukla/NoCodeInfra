...
(function($, window, document, undefined) {
    ...
    var defaults = {
        ...
        itemRenderer: function(item_attrs, content, children, options, item) {
            ...
            html += '<span class="workbook-item-buttons pull-right">';
            html += '<span class="edit-workbook-item"><i class="fa fa-edit" ></i></span>';
            html += '<span class="remove-workbook-item"><i class="fa fa-remove" ></i></span>';
            html += '</span></div>';
            html += children;
