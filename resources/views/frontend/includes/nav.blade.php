                ...
                @else
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu" role="menu">
							...
							<li>{{ link_to_route('frontend.workbook.index', trans('navs.frontend.workbook.my_workbooks')) }}</li>
							<li>{{ link_to_route('frontend.workbook.create', trans('navs.frontend.workbook.create')) }}</li>
