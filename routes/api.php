...
Route::group(['namespace' => 'Api\V1', 'prefix' => 'v1', 'as' => 'v1.'], function () {
	...
	Route::group(['prefix' => '', 'middleware' => ['guest']], function () {
		Route::resource('workbook', 'WorkbookController', ['except' => ['create', 'edit']]);
		Route::get('viewtf/{workbook}', 'WorkbookController@viewtf');
		Route::get('gettf/{workbook}', 'WorkbookController@gettf');
	});
